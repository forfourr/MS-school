...
# label 1 - > damage
annfile_path = "computervision/data/car_damage_dataset/train/COCO_train_annos.json"
mul_annfile_path = "computervision/data/car_damage_dataset/train/COCO_mul_train_annos.json"
img_path = "computervision/data/car_damage_dataset/img/"
