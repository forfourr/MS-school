...
from customdataset_02_painting import CustomDataset
...
def main():
    ...
    model.load_state_dict(torch.load(f=f'{PATH}/art_best.pt'))
    ...
    test_dataset = CustomDataset(f"{PATH}/paintings/val",
                                    val_transfrom)
